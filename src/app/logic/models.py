...
from app.logic.validators import validate_grid, validate_game_state
from app.logic.exceptions import InvalidMove, UnknownGameScore
    ...
    def make_move_to(self, index: int) -> Move:
        ...
        return Move(
            ...
            after_state=GameState(Grid(
                self.grid.cells[:index] + self.current_mark + self.grid.cells[index + 1:]), self.starting_mark)
        )
